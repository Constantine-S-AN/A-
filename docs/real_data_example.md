...
## 5) 一次真实跑数样例（2026-02-20）
以下是本仓库在真实拉取后的一个示例结果（区间：`20240101~20240630`，股票池：`002261.SZ,603598.SH,000957.SZ`）：

`strategy_compare.csv`

| fill_model | trade_count | total_return | max_drawdown | win_rate |
|---|---:|---:|---:|---:|
| IDEAL | 13 | 0.258312 | -0.062290 | 0.615385 |
| CONSERVATIVE | 13 | 0.258312 | -0.062290 | 0.615385 |

解释：
- 这个样本期内，策略触发样本以“可买入”场景为主，因此 IDEAL/CONSERVATIVE 暂未分化。
